...
PARAM_NAME="/app/${APPLICATION}/${ENV}/pricing-algorithm/dat-secret"
...
if [ -n "${VALUE}" ]; then
  ...
  echo "The DAT secret does not yet exist in Parameter Store, you need to run the deploy.sh script."
  exit 1
fi